 ...
 */
@WebServlet("/mypage_regist")
public class mypage_regist extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		query = "INSERT INTO profile VALUES ('" + e_mail + "','" + nickname + "','" 
											 + introduce + "','" + job + "','" + tendency + "','" + date + "','" + smoking + "','" + pet + "')";
		...
		try {
            ...
            out.println("<script>");
    		out.println("alert('프로필 등록이 완료되었습니다.');");
